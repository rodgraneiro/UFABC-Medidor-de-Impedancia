...
xlabel('RESISTÊNCIA DO TRIMPOT [\Omega] - MEDIDA COM MULTÍMETRO')
ylabel('IMPEDÂNCIA DO TRIMPOT [\Omega] - MEDIDA COM MIE')
%axis equal
...
legend('RESISTÊNCIA TRIMPOTs','Equação da reta (Z)');
a = p(:,1);
b = p(:,2);
...
legend('FASE MEDIÇÃO TRIMPOTs', 'Equação da reta (fase)');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
